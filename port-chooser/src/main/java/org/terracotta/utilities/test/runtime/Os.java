 ...
 * @author teck
 */
// Migrated from https://github.com/Terracotta-OSS/terracotta-core/blob/master/common/src/main/java/com/tc/util/runtime/Os.java
public class Os {
  ...
  public static boolean isUnix() {
    ...
    if ((os.contains("sunos")) || (os.contains("linux"))) { return true; }
  ...
  /**
   * Gets the Windows "System" folder.  This is usually {@code C:\Windows\System32}.
   * @return the Windows "System" folder
   */
